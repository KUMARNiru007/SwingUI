...
import bigwindowimg from "../assets/Hero-assets/bigwindow.png";
import smallwindowleftimg from "../assets/Hero-assets/smallwindowleft.png";
import smallwindowrightimg from "../assets/Hero-assets/smallwindowright.png";
import herobg from "../assets/Hero-assets/herobg.png";
...
const Hero = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      gsap.from([headingRef.current, subheadingRef.current, paragraphRef.current, ctaRef.current], {
        opacity: 0,
        y: 50,
        duration: 1,
        ease: 'power3.out',
    ...
    >
      ...
      <div className="w-full text-center space-y-6">
        ...
        >
          <Link
            to="/docs"
            className="px-6 py-3 rounded-full text-white swing-ocean-gradient font-semibold shadow hover:opacity-90 transition"
          >
            Get Started For Free
          </Link>
          <Link
            to="/components/button"
            className="px-6 py-3 rounded-full border border-gray-300 text-gray-900 font-semibold hover:bg-gray-100 transition"
          >
      ...
      <div
        ...
        className="relative mt-0 sm:mt-20 w-full max-w-6xl px-4 flex items-center justify-center"
      >
        <img
          src={bigwindowimg}
          alt="Big Window"
