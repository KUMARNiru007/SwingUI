...
import {FaPalette,FaBars,FaUserCircle,FaSpinner,FaMousePointer,} from "react-icons/fa";
import '../../src/index.css';

const items = [
  { icon: <FaMousePointer />, title: "Button", desc: "Customizable button styles" },
    ...
    <div className="w-full overflow-hidden py-6">
      ...
      >
        {duplicatedItems.map((item, i) => (
          <div key={`${direction}-${i}`} className="w-[calc(50%-0.5rem)] sm:w-auto">
            <GalleryCard
              icon={item.icon}
              title={item.title}
              desc={item.desc}
...
const ComponentsFeaturesGallery = () => {
  return (
    <div className="bg-[#06141f] min-h-screen px-4 py-16 text-white w-full overflow-x-hidden font-sans">
      <div className="text-center mb-12 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-[#2ca7cf]">Components & Features</h2>
