...
import CodeBlock from '../internal-components/CodeBlock/CodeBlock';
...
function DataComponent() {
  ...
  return (
    <div className={`mx-auto px-6 py-6 w-full ${darkMode ? 'bg-[var(--dark-bg)] text-[var(--color-text-dark)]' : 'bg-[var(--light-bg)] text-[var(--color-text)]'}`}>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Getting Started with Components</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Hot Module Replacement</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2">Dependency Management</h2>
      <p className="mb-4">
