...
const Button = () => {
  ...
  const propertiesData = [
    ...
    },
    {
      ...
      description: 'An animated swing button with continous gradient motion',
    },
    {
      className: 'swing-ocean-gradient-animate hover:swing-ocean-gradient ',
      section: 'Animated swing button ',
      description:
        'An animated swing button that changes its gradient on hover',
    },
  ];
    ...
    >
      <div className='max-w-5xl mx-auto px-1 py-8 sm:py-12'>
        ...
        <p className='mb-10 sm:mb-16'>
          ...
          Each button type is designed to deliver an interactive and visually
          appealing UI element.
        </p>
