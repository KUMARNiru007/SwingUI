...
//       <h2 className='text-3xl sm:text-4xl font-bold mb-2'>Testimonial Component</h2>
//       <p className='mb-6'>
//       This animated testimonial component displays continuously scrolling user feedback in
// a visually engaging format, with light/dark theme support and live code preview toggling
// for developer ease.
//       </p>
...
//       <PreviewCodeBtn className="ml-auto" showCode={showCode} setShowCode={setShowCode} />
//       </div>
//       {!showCode && (
//         <div
