    ...
    >
      <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-6'>
        ...
        <p className='mb-10 sm:mb-16'>
          This accordion component provides an interactive way to display
          information in collapsible sections, optimizing space usage while
          maintaining a clean user interface. Perfect for FAQs, product details,
